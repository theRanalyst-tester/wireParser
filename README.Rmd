...
#### How to Use the App
_First and foremost, you need to have R and RStudio installed. If you do not have these things installed, please Google how to do this. In addition, you will need to install poppler utils. You can Google "pdftotext" to find a file from which to download._
